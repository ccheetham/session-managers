...
/**
 * Implements {@link io.pivotal.appsuite.tomcat.BackendStore} behavior specific to Tomcat 8.5.
 */
public class Tomcat85Adapter implements io.pivotal.appsuite.tomcat.TomcatAdapter {
